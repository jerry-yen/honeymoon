<?php 
	if($this -> module_loader -> is_exists("pagination")):
		$page_info = $this -> module_pagination -> get_page_list(); 
		$next_page = $this -> module_pagination -> get_next_page();
		$prev_page = $this -> module_pagination -> get_previous_page();
?>
