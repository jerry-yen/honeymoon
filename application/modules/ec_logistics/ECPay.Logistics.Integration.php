<?php
    ...
    class ECPayLogistics {
        ...
        public function CreateShippingOrder($ButtonDesc = '物流訂單建立', $Target = '_self') {
            ...
            // 產生 CheckMacValue
            $this->PostParams['CheckMacValue'] = ECPay_CheckMacValue_1::generate($this->PostParams, $this->HashKey, $this->HashIV);
        ...
        public function CheckOutFeedback($Feedback = array()) {
            ...
            if (!isset($Feedback['CheckMacValue'])) {
                ...
                $CheckMacValue = ECPay_CheckMacValue_1::generate($Feedback, $this->HashKey, $this->HashIV);
    ...
    if (!class_exists('ECPay_CheckMacValue_1', true)) {
        class ECPay_CheckMacValue_1
        {
            /**
            * 產生檢查碼
            */
            static function generate($arParameters = array(), $HashKey = '', $HashIV = ''){
                ...
                if(isset($arParameters)){
                    ...
                    uksort($arParameters, array('ECPay_CheckMacValue_1','merchantSort'));
                    ...
                    // 取代為與 dotNet 相符的字元
                    $sMacValue = ECPay_CheckMacValue_1::Replace_Symbol($sMacValue);
