<?php
class Subsidy_Component extends Component {
	...
	private function get_row_object($fieldMetadata){
		$render ='			<tr class="' . $this -> variable . '_item">
                            	...
                            	<td><input type="text" class="form-control" name="' . $this -> variable . '_field_price[]" value="' . $fieldMetadata -> {$this -> variable . "_field_price"} . '"></td>
